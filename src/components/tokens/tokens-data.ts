...
export const iconSizeScale = [
  { className: "size-3.5", label: "3.5" },
  { className: "size-4", label: "4 (default)" },
  { className: "size-5", label: "5" },
  { className: "size-6", label: "6" },
  { className: "size-8", label: "8" },
];

export const controlHeightScale = [
  { className: "h-8", label: "h-8 · sm" },
  { className: "h-9", label: "h-9 · default" },
  { className: "h-10", label: "h-10 · lg" },
];

export const leadingScale = [
  { className: "leading-none", label: "leading-none" },
  { className: "leading-tight", label: "leading-tight" },
  { className: "leading-snug", label: "leading-snug" },
  { className: "leading-normal", label: "leading-normal" },
  { className: "leading-relaxed", label: "leading-relaxed" },
  { className: "leading-loose", label: "leading-loose" },
];

export const trackingScale = [
  { className: "tracking-tighter", label: "tracking-tighter" },
  { className: "tracking-tight", label: "tracking-tight" },
  { className: "tracking-normal", label: "tracking-normal" },
  { className: "tracking-wide", label: "tracking-wide" },
  { className: "tracking-wider", label: "tracking-wider" },
  { className: "tracking-widest", label: "tracking-widest" },
];

export const zIndexScale = [
  { className: "z-0", label: "Contenuto di pagina", value: "0" },
  { className: "z-40", label: "Header sticky", value: "40" },
  { className: "z-50", label: "Menu, popover, tooltip, dialog", value: "50" },
];
